...
<!-- container s -->
	...
	<form id="orderForm" name="orderForm">
		<input name="itemIdx" type="hidden" value="23" />
				...
				<div class="menu_info">
					<div class="menu_info">
						...
						<figure class="img">
							...
							<img onError="this.src='/images/common/noneImage.jpg'" alt="로스트 치킨" src="/upload/item/Roasted-Chicken_20211231100910048.png" />
						</figure>
						<!--// 2019-12-02 #172 제품썸네일 영역 마크업 수정 (figure 태그로 감쌈) -->
							...
							<h3>
								...
								<em>
									...
									<label class="my_bookmark">
										<input onclick="favoriteMenu.favor(this);" type="checkbox" data-itemidx="23" />
										<i class="i_star"></i>
									</label>
								</em>
							</h3>

							<p>오븐에 구워 담백한 닭 가슴살 치킨 패티로 맛과 영양 모두를 만족시키는 메뉴!</p>
							

							<button class="btn bgc_point i_reg" id="itemConbiPopBtn" style="width:183px;" type="button" data-item-gubun="sandwich" data-store-cd="64444" data-combination-idx="35" data-item-code="00012" data-subpick="N">
								<span>추천 꿀 조합</span>
					...
					<div class="btn_area">
						...
						<button class="btn i_reg btn_order bgc_point" id="orderBtn" type="button" data-promotionYn="N" data-itemType="ITEM_SANDWICH" data-morningYn="N"><span>주문 시작하기</span></button>
