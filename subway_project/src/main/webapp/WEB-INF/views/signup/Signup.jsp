                ...
                <form action="signupDo" method="post" onsubmit="return validation()">
                    ...
                    <div id="value">
                        ...
                        비밀번호 확인 : <input type="password" id="pwcheck" oninput="pwCheck()"
                            name="pwcheck" style="width:200px"><br>
                        <div id="result4"></div>
                    </div>
                    ...
                    <div id="value">
                        ...
                        <input type="text" id="address" name="address" placeholder="주소"
                            readonly="readonly" style="width:300px"><br> <input type="text"
                            id="detailAddress" name="detailAddress" placeholder="상세주소" style="width:150px">
                        <input type="text" id="extraAddress" name="extraAddress"
                            placeholder="참고항목" readonly="readonly" style="width:150px"><br>
                    </div>
                    ...
                    <div id="value">
                        이메일 : <input type="text" id="email1" name="email1" style="width:200px"> @ <select
